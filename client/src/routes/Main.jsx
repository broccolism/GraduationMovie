    ...
    <>
      {isLoading ? (
        ...
        <div class="main">
          ...
          <div class="main__best-recommend">
            <div class="main__best-recommend-image-wrapper">
              <div class="main__best-recommend-image">
                <img src={bestRecommendPoster.imageUrl} />
              </div>
              <div class="main__transparent-layer"></div>
            </div>
            <div class="main__best-recommend-text">
              <div class="main__emphasis">best fit!</div>
              <div class="main__description">{bestRecommendPoster.title}</div>
            </div>
          </div>

          <div class="main__item-similar-recommend">
            <VerticalListView movieList={movieList} />
          </div>
          <div class="main__reload-button">
            <button class="border-white-button">
              <i class="fas fa-redo"></i> &nbsp;&nbsp; I want more
            </button>
          </div>
          ...
          <div class="main__user-similar-recommend">
